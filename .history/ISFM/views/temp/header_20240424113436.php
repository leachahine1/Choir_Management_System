...
.page-sidebar-menu .sub-menu li a.nav-link:hover {
    ...
    background-color: #8080ff; /* Apply a purple background */
    color: white; /* Optional: changing the text color to white for better visibility */
    transition: background-color 0.3s; /* Smooth transition for background color changes, if needed */
}
/* Adjust color on hover to slightly different shade if desired */
.page-sidebar-menu > li.<?php echo $dashbord; ?> > a:hover {
    background-color: #8080ff; /* Change to a different shade of purple on hover */
}
