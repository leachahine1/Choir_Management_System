...
.nav-item a.nav-link.nav-toggle {
    transition: background-color 0.3s; /* Smooth transition for background color */
}

.nav-item a.nav-link.nav-toggle:hover {
    background-color: #f5f5f5; /* Change background to purple on hover */
}
.nav-item a.nav-link.title:hover {
    background-color: #f5f5f5; /* Change background to purple on hover */
}
.nav-item a.nav-link:hover {
    background-color: #f5f5f5; /* Change background to purple on hover */
}
/* Ensure the CSS targets only <a> tags inside 'sub-menu' lists */
.sub-menu .nav-item a.nav-link {
    transition: background-color 0.3s; /* Smooth transition for background color */
    display: block; /* Make sure the <a> tag covers the entire area of the list item */
}

.sub-menu .nav-item a.nav-link:hover {
    background-color: purple; /* Change background to purple on hover */
}
</style>
        <!-- BEGIN CONTAINER -->
