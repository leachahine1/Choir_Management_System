    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">HAAAAAAAAAA
                    ...
                    <div id="tab_0" class="tab-pane active">
                        <div class="portlet box purple">
                            ...
                            <div class="portlet-body form">
                                ...
                                echo form_open('section_leaders/section_leadersInformation', $form_attributs);
                                ?>
                                <div class="form-body">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label"> <?php echo lang('par_cla_tit'); ?> </label>
                                        <div class="col-md-4">
                                            <select onchange="ChoirSection(this.value)"  class="form-control" name="Choir_id">
                                                <option value=""><?php echo lang('select'); ?>hhhhhhhhhh</option>
                                                <?php foreach ($s_Choir as $row) { ?>
                                                    <option value="<?php echo $row['id']; ?>"><?php echo $row['Choir_title']; ?></option>
                                                <?php } ?>
                                            </select>
                                            <span class="help-block"><?php echo lang('At first select any class and click the "view Section_trainers" button.'); ?> </span>
                                        </div>
                                    </div>
