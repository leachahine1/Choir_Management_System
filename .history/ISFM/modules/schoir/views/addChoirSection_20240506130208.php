    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <?php echo lang('clas_add_Choir'); ?> <small></small>
                </h3>
            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box purple ">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open('sChoir/addChoir', $form_attributs);
                        ?>
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="form-control" class="form-control" placeholder="<?php echo lang('clas_title_plash'); ?>" name="Choir_title" data-validation="required" data-validation-error-msg="<?php echo lang('clas_cls_tit_requi'); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select name="capicity" class="form-control"  data-validation="required" data-validation-error-msg="Select section's Choir_member capacity.">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" onkeyup="ChoirSection(this.value)" class="form-control" placeholder="<?php echo lang('clas_code_plash'); ?>"  data-validation="required" data-validation-error-msg="<?php echo lang('clas_code_requir'); ?>">
                                        <span id="ajaxResult" class="ChoirCodeCheck"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-actions fluid">
                                <div class="col-md-offset-3 col-md-6">
                                    <button type="submit" name="submit" class="btn green" value="Add Choir"><?php echo lang('clas_add_butt'); ?></button>
...
//here is auto reload after 1 second for time and date in the top
    ...
    function ChoirSection(str) {
        ...
        xmlhttp.open("GET", "index.php/sChoir/ajaxChoirCodeInfo?q=" + str, true);
        xmlhttp.send();
    }
</script>
