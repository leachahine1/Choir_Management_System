                            ...
                            <div class="form-body">
                                <div class="alert alert-info marginBottomNone">
                                    <div class="form-group marginBottomNone">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <input type="hidden" name="Choir" value="<?php echo $Choir_id; ?>">
...
<?php } ?>
                                                ...
                                                <div class="col-md-2 routineFildMarginBottom">
                                                    <select class="form-control" name="song" data-validation="required" data-validation-error-msg="">
                                                        <option value=""><?php echo lang('clas_select_song'); ?></option>
...
<?php } ?>
                                                ...
                                                <div class="col-md-2 routineFildMarginBottom">
                                                    <select class="form-control" name="section_leader" data-validation="required" data-validation-error-msg="">
                                                        <option value=""><?php echo lang('clas_select_section_leader'); ?></option>
...
<?php } ?>
                            ...
                            <div class="form-actions fluid marginTopNone">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <button class="btn default" type="reset"><?php echo lang(''); ?></button>
                                </div>
                            </div>
                        <?php echo form_close(); ?>
