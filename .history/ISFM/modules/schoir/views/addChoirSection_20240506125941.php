                        ...
                        ?>
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="Choir" class="form-control" placeholder="<?php echo lang('clas_title_plash'); ?>" name="Choir_title" data-validation="required" data-validation-error-msg="<?php echo lang('clas_cls_tit_requi'); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
