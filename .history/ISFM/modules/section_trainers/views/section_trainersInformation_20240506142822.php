                            ...
                            <tbody>
                                <?php foreach ($section_trainers as $row) { ?>
                                    <tr>
                                        ...
                                        <?php if ($this->common->user_access('section_trainers_edit_dlete', $userId)) { ?>
                                        <td>
                                        <a class="btn btn-xs default" href="index.php/section_trainers/editSection_trainersInfo?id=<?php echo $row['id']; ?>&uid=<?php echo $row['user_id']; ?>">
                                                                    <i class="fa fa-pencil-square"></i> <?php echo lang('edit'); ?>
                                                                </a>
