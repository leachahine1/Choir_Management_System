    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <?php echo lang('header_all_rehearsal_rout'); ?><small></small>
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <?php echo lang('header_all_rehearsal_rout'); ?>
                    </li>
            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box purple ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-bars"></i> <?php echo lang('exa_scfer'); ?>
                        </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open('rehearsal/routinView', $form_attributs);
                        ?>
                        <div class="form-body">
                        ...
                        <div class="form-actions fluid "  style="color: purple;">
                            <div class="col-md-offset-3 col-md-9">
                                <button class="btn purple" name="submit" type="submit" value="View Routine"><?php echo lang('exa_viewro'); ?></button>
