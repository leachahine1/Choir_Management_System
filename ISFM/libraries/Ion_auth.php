...
class Ion_auth
    ...
    public function __construct()
        ...
        $lang = $this->db->get('configuration')->row();
        $this->lang->load('ion_auth',$lang->language);
    ...
    public function is_Choir_member($id = false)
        {
        $this->ion_auth_model->trigger_events('is_Choir_member');

        $Choir_member_group = $this->config->item('Choir_member_group', 'ion_auth');

        return $this->in_group($Choir_member_group, $id);
        }

    public function is_section_leader($id = false)
        {
        $this->ion_auth_model->trigger_events('is_section_leader');

        $section_leader_group = $this->config->item('section_leader_group', 'ion_auth');

        return $this->in_group($section_leader_group, $id);
        }

    public function is_section_trainers($id = false)
        {
        $this->ion_auth_model->trigger_events('is_section_trainers');

        $section_trainers_group = $this->config->item('section_trainers_group', 'ion_auth');

        return $this->in_group($section_trainers_group, $id);
        }
