            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open('songs/set_optional', $form_attributs);
                        ?>
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" onkeyup="Choir_memberInfo(this.value)" name="Choir_member_id" class="form-control" placeholder="<?php echo lang('sub_stu_id_plash'); ?>" data-validation="required" data-validation-error-msg="">
                                    </div>
                                </div>
...
//here is auto reload after 1 second for time and date in the top
    ...
    function optional_song(str) {
        ...
        xmlhttp.open("GET", "index.php/songs/optional_song?c_id=" + str, true);
        xmlhttp.send();
    }
</script>
