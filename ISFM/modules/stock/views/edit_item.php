                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <select onchange="ChoirStuAndPar(this.value)" name="vendor_id" class="form-control select2me"  data-validation="required" data-validation-error-msg="<?php echo lang('sto_vrm'); ?>">
