                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select id="reseverGroup" onchange="selectReceiver(this.value)" class="form-control" name="user_type"  data-validation="required">
                                        ...
                                        <option value="Choir_member"><?php echo lang('gr_Choir_member'); ?></option>
                                        <option value="Employee"><?php echo lang('sto_emp'); ?></option>
                                        <option value="Section_trainers"><?php echo lang('gr_section_trainers'); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <select id="ajaxResult" onchange="ChoirStuAndPar(this.value)" name="receiver" class="form-control select2me" data-placeholder="<?php echo lang('select'); ?>"  data-validation="required">
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                foreach ($issu_item as $row2) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-xs red" href="index.php/stock/delete_issue?id=<?php echo $row2['id']; ?>" onClick="javascript:return confirm('Are you sure you want to delete this Choir?')"> <i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?> </a>
                                        </td>
                                    </tr>
                                    <?php
                                    $i++;
...
<script>
    ...
    function ChoirStuAndPar(str) {
        ...
        xmlhttp.open("GET", "index.php/stock/ajaxChoirStuAndPar?p=" + str + "&g=" + val, true);
        xmlhttp.send();
    }
