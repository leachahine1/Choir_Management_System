                        ...
                        ?>
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select id="reseverGroup" onchange="ajaxChoirSong(this.value)" class="form-control" name="Choir" data-validation="required" data-validation-error-msg="">
                                            <option value=""><?php echo lang('select'); ?></option>
                                            <?php foreach($Choir as $row){?>
                                            <option value="<?php echo $row['Choir_title']; ?>"><?php echo $row['Choir_title']; ?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                </div>
...
<script>
    function ajaxChoirSong(str) {
        ...
        xmlhttp.open("GET", "index.php/suggestion/ajaxChoirSong?cla=" + str, true);
        xmlhttp.send();
    }
