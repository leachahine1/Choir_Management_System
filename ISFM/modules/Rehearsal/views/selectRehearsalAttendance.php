    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <?php echo lang('header_tak_exa_att'); ?><small></small>
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <?php echo lang('header_tak_exa_att'); ?>
                    </li>
            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box purple ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-bars"></i> <?php echo lang('exa_scfea'); ?>
                        </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open('rehearsal/rehearsalAttendance', $form_attributs);
                        ?>
                        <div class="form-body">
                        ...
                        <div class="form-actions fluid">
                            <div class="col-md-offset-3 col-md-9">
                                <button class="btn blue" type="submit"><?php echo lang('exa_take_att'); ?></button>
