            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <?php echo $rehearsalTitle . ' Song [ ' . $rehearsalSong . ' ] For "' . $ChoirTitle . '"'; ?> <?php echo lang('exa_atten'); ?>
                        </div>
                        <div class="tools">
                        </div>
                    </div>
                    <div class="portlet-body form">
                        ...
                        echo form_open("rehearsal/rehearsalAttendance?id=$rehearsalId", $form_attributs);
                        ?>
                        <div class="form-body">
                        ...
                        foreach ($Choir_members as $row) {
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" name="Choir_memberName_<?php echo $i; ?>" value="<?php echo $row['Choir_member_title']; ?>" class="form-control" readonly="">  
                                    </div>
                                    <div class="col-sm-3">
                                    ...
                                    <input type="hidden" name="Choir_memberInfoId_<?php echo $i; ?>" value="<?php echo $row['Choir_member_id'] ?>">
                                    <input type=hidden name="Choir_id" value="<?php echo $row['Choir_id']; ?>">
