            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box purple ">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open('rehearsal/addRehearsal', $form_attributs);
                        ?>
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-3 control-label"> <?php echo lang('exa_etit'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="" name="rehearsalTitle" required="">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> <?php echo lang('exa_Rehearsal_month'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-6 classGroupInput">
                                    <select class="form-control" name="rehearsalMonth" plase required="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="Choir_id" required="">
