                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <?php echo lang('exa_song'); ?>
                                    </th>
                                    <th>
                                        <?php echo lang('exa_atten'); ?>
                                    </th>
                                    <?php if ($this->common->user_access('change_rehearsal_attendance', $userId)) { ?>
                                        <th>
                            ...
                            <tbody>
                                <?php foreach ($previerAttendance as $row) { ?>
                                    <tr>
                                        ...
                                        <?php if ($this->common->user_access('change_rehearsal_attendance', $userId)) { ?>
                                            <td>
                                                <a class="btn btn-xs default tableActionButtonMargin" href="index.php/rehearsal/editRehearsalAttendance?id=<?php echo $row['id']; ?>"> <i class="fa fa-pencil-square"></i> <?php echo lang('edit'); ?> </a>
                                            </td>
                                        <?php } ?>
                                    </tr>
                                <?php } ?>
