                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-actions fluid">
                            <div class="col-md-offset-3 col-md-6">
                                <button type="submit" class="btn yellow" name="submit" onclick="location.href = 'index.php/rehearsal/approuveResultShit?id=<?php echo $rehearsalId; ?>&Choir=<?php echo $Choir; ?>'"><?php echo lang('exa_acc_res_shee'); ?></button>
