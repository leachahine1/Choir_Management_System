                            ...
                            <tbody>
                                <?php foreach ($grade as $row) { ?>
                                    <tr>
                                        ...
                                        <?php if ($this->common->user_access('rehearsal_gread', $userId)) { ?>
                                            <td>
                                                <a class="btn btn-xs default" href="index.php/rehearsal/editGrade?id=<?php echo $row['id']; ?>"> <i class="fa fa-pencil-square"></i> <?php echo lang('edit'); ?> </a>
                                                <a class="btn btn-xs red" href="index.php/rehearsal/deleteGrade?id=<?php echo $row['id']; ?>" onclick="javascript:return confirm('<?php echo lang('exa_aysywtdteg'); ?>')"> <i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?> </a>
                                            </td>
                                        <?php } ?>
                                    </tr>
                                <?php } ?>
