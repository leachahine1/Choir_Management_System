            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open('rehearsal/makingResult', $form_attributs);
                        ?>
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select onchange="selectChoir(this.value)" class="form-control" name="Choir_id" data-validation="required" data-validation-error-msg="">
                                ...
                                <input type="hidden" name="section_leaderUserId" value="<?php echo $user->id; ?>">
                            </div>
...
<script>
    function selectChoir(str) {
        ...
        xmlhttp.open("GET", "index.php/rehearsal/ajaxChoirResult?q=" + str, true);
        xmlhttp.send();
    }
    function rehearsalSong(str) {
        var xmlhttp;
        if (str.length == 0) {
        ...
        xmlhttp.open("GET", "index.php/rehearsal/ajaxRehearsalSong?erid=" + str, true);
        xmlhttp.send();
    }
    function rehearsalSongTitle(str) {
        var xmlhttp;
        if (str.length == 0) {
        ...
        xmlhttp.open("GET", "index.php/rehearsal/ajaxRehearsalSubTitle?erid=" + str, true);
        xmlhttp.send();
    }
</script>
<script>
