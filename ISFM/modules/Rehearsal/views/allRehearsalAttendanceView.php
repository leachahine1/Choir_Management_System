            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-bars"></i> <?php echo lang('exa_scaetfac'); ?> 
                        </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open('rehearsal/viewRehearsalAttendance', $form_attributs);
                        ?>
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-3 control-label"> <?php echo lang('exa_Choir'); ?> <span  classGroupInput> * </span></label>
                                <div class="col-md-6">
                        ...
                        <div class="form-actions fluid">
                            <div class="col-md-offset-3 col-md-9">
                                <button class="btn blue" type="submit" name="submit" value="View Attendance"><?php echo lang('exa_vattbutt'); ?></button>
...
<script>
    function ChoirSection(str) {
        ...
        xmlhttp.open("GET", "index.php/rehearsal/ajaxAttendanceView?q=" + str, true);
        xmlhttp.send();
    }
</script>
<script>
