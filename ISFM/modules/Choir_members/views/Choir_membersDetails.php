    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    Choir_members Details <small> Information</small>
                </h3>
                ...
                <div class="col-md-3">
                    <ul class="ver-inline-menu tabbable margin-bottom-10">
                        ...
                        <?php if($this->common->user_access('stud_edit_delete',$userId)){ ?>
                            <li>
                                <?php
                                $Choir_memberChoirId = $this->input->get('di');
                                $Choir_memberInfoId = $this->input->get('sid');
                                $stuUserId = $this->input->get('userId');
                                $Choir = $this->input->get('Choir');
                                ?>
                                <a href="index.php/Choir_members/editChoir_member?di=<?php echo $Choir_memberChoirId; ?>&sid=<?php echo $Choir_memberInfoId; ?>&userId=<?php echo $stuUserId; ?>&Choir=<?php echo $Choir; ?>">
                    ...
                    <div class="row">
                        <div class="col-md-12 profile-info">
                            ...
                            foreach ($Choir_memberInfo as $row) {
                                ...
                                $Choir_memberPercentise = $row['attendance_percentices_daily'];
                                ...
                                $query2 = $this->db->get_where('Choir_member_info', array('Choir_member_id' => $Choir_memberId));
                                ...
                                ?>
                                <h1 class="section_leaderTitleFont"><?php echo $first_name . ' ' . $last_name; ?></h1>
                                <div class="row">
                                    <div class="col-sm-4 col-xs-6 detailsEvent">
                                        <span>: </span>
                                        <?php echo lang('stu_d_Choir'); ?>
                                    </div>
                                    <div class="col-sm-6 col-xs-6 detailsEvent">
                                        <?php echo $row['Choir_title']; ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4 col-xs-6 detailsEvent">
                        ...
                        <div class="portlet-body">
                            <ul class="list-unstyled">
                                <li>
                                    ...
                                    <span class="sale-num">
                                        <?php echo $Choir_memberPercentise; ?> % </span>
                                </li>
                            </ul>
                        </div>
                        <div class="row">
        ...
        <!-- BEGIN TAB PORTLET-->
        <div class="portlet box Choir_memberDetails tabbable">
            <div class="portlet-title">
                <div class="caption">
            ...
            <div class="portlet-body">
                <div class=" portlet-tabs">
                    <ul class="nav nav-tabs" onp>
                        <?php
                        $exTitle = array();
                        //Here is checked rehearsal by class title
                        $Choir_id = $row['Choir_id'];
                        $yearR = date('Y');
                        $query3 = $this->db->query("SELECT id,rehearsal_title FROM add_rehearsal WHERE Choir_id=$Choir_id AND year=$yearR");
                        $i = 1;
                        foreach ($query3->result_array() as $row3) {
                            ...
                            ?>">
                                <a href="#portlet_tab2_<?php echo $i; ?>" data-toggle="tab">
                                    <?php echo $row3['rehearsal_title']; ?> </a>
                            </li>
                            <?php
                            $exTitle[] = $row3;
                            $i++;
...
//                                    echo $exex['id'].'<br>';
                            $markSheet = $this->Choir_membermodel->markshit($exex['rehearsal_title'], $Choir_id, $row['Choir_member_id']);
                            ?>
                                    ...
                                    <div class="col-md-12" id="print">
                                        <div class="portlet box green">
                                            ...
                                            <div class="portlet-body">
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover" id="sample_1">
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($markSheet as $MarShee) { ?>
                                                                <tr>
                                                                    <td>
                                                                        <?php echo $MarShee['rehearsal_song']; ?> 
                                                                    </td>
                                                                    <td>
                                                ...
                                                <?php
                                                $query4 = $this->db->query("SELECT total_mark,final_grade,point,fail_amount FROM final_result Where Choir_member_id='$Choir_memberId'");
