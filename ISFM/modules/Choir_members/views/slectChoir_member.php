                    ...
                    <div id="tab_0" class="tab-pane active">
                        <div class="portlet box green">
                            ...
                            <div class="portlet-body form">
                                ...
                                echo form_open('Choir_members/allChoir_member', $form_attributs);
                                ?>
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"> <?php echo lang('stu_sel_cla_Choir'); ?> </label>
                                            <div class="col-md-4">
                                    ...
                                    <div class="form-actions bottom fluid ">
                                        <div class="col-md-offset-3 col-md-9">
                                            <button class="btn green" name="submit" type="submit" value="Submit"><?php echo lang('stu_sel_cla_view_Choir_member'); ?></button>
