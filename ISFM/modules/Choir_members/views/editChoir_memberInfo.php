        ...
        <div class="row">
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    ...
                    foreach ($Choir_memberInfo as $row1) {
...
//                        $Choir_id = $row1['Choir_id'];
                        $last_Choir_certificate = $row1['last_Choir_certificate'];
                        $t_c = $row1['t_c'];
                    ...
                    $Choir = $this->common->Choir_title($Choir_id);
                    $m = '';
                    $f = "";
                    $o = "";
                    if ($sex == 'Male') {
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open("Choir_members/editChoir_member?di=$Choir_memberChoir&sid=$Choir_memberInfoId&userId=$userId&Choir_id=$Choir_id", $form_attributs);
                        ?>
                        <div class="form-body">
                            <?php
                            if (!empty($success)) {
...
<?php foreach ($ChoirChoir_members as $row3) { ?>
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><?php echo lang('admi_Choir'); ?> </label>
                                    <div class="col-md-6">
                                        <select class="form-control" name="Choir">
                                            <option class="claasSelectBGColor"  value="<?php echo $Choir; ?>"><?php echo $Choir; ?></option>
                                            <?php foreach ($s_Choir as $row2) { ?>
                                                <option value="<?php echo $row2['id']; ?>" ><?php echo $row2['Choir_title']; ?></option>
    <?php } ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" value="<?php echo $row3['Choir_member_id']; ?>" name="Choir_member_id" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="checkbox-list">
                                        <label>
                                            ...
                                            if (!empty($last_Choir_certificate)) {
                                                echo 'checked value="submited"';
                                            }
                                            ?>> Previous  Choir Certificate. </label>
                                        <label>
