            ...
            <div class="col-md-12">
                ...
                <div class="portlet box purple">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open('dailyAttendance/section_leaderAttendance', $form_attributs);
                        ?>
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <select onchange="ChoirStuAndPar(this.value)" name="section_leader" class="form-control select2me" data-placeholder="" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <select onchange="ChoirStuAndPar(this.value)" name="presAbsent" class="form-control select2me" required>
