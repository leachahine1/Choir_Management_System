    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <?php echo lang('att_Choir_atten'); ?> <small></small>
                </h3>
                        ...
                        foreach ($Choir_members as $row) {
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" name="atudentName_<?php echo $i; ?>" value="<?php echo $row['Choir_member_title']; ?>" class="form-control" readonly="">  
                                    </div>
                                    <div class="col-sm-3">
