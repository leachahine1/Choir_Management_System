...
<div class="page-content-wrapper">
                            ...
                            <div class="portlet-body form">
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="Choir_title" onchange="attendanceChoirSection(this.value)" class="form-control">
    ...
    <script>
        ...
        function attendanceChoirSection(str) {
            var xmlhttp;
            if (str.length === 0) {
            ...
            xmlhttp.open("GET", "index.php/dailyAttendance/ajaxChoirAttendanceSection?q=" + str, true);
            xmlhttp.send();
        }
    </script>
