            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box purple ">
                    <div class="portlet-title">
                        <div class="caption">
                            Select Choir For Yearly Promotion.
                        </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open('sChoir/promotion', $form_attributs);
                        ?>
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Promotion Next Choir <span class="requiredStar"> * </span></label>
                                    <div class="col-md-6">
...
<script>
    function ChoirSection(str) {
        ...
        xmlhttp.open("GET", "index.php/sChoir/ajaxpromotion?q=" + str, true);
        xmlhttp.send();
    }
</script>
