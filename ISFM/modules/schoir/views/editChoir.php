    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <?php echo lang('clas_edit_clas_sec'); ?> <small></small>
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <?php echo lang('header_info'); ?>
                        
                    </li>
                    <li>
                        <?php echo lang('clas_edit_clas_sec'); ?>
                    </li>
            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-bars"></i> <?php echo lang('clas_edit_cla_info'); ?> 
                        </div>
                        <div class="tools">
                        ...
                        ?>
                            ...
                            <div class="form-actions fluid">
                                <div class="col-md-offset-3 col-md-6">
                                    <button type="submit" name="submit" class="btn green" value="Add Choir"><?php echo lang('clas_up_button'); ?></button>
