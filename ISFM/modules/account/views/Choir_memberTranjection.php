            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box purple ">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open('account/Choir_memberTranjection', $form_attributs);
                        ?>
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-3 control-label"> <?php echo lang('acc_stud_id'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-6">
                                    <input  class="form-control" type="text" name="Choir_memberId"  onkeyup="Choir_memberInfo(this.value)" placeholder="" data-validation="required" data-validation-error-msg="<?php echo lang('acc_stud_id_rmes'); ?>">
                                </div>
                            </div>
                                    ...
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo lang('acc_rehearsalfee'); ?>
                                                </td>
                                                <td>
                                                    <input class="col-xs-2 form-control"type="text" name="rehearsal_fee" placeholder="   - - - - -">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <input class="col-xs-2 form-control"type="text" name="section_leader_welfare_fund" placeholder="   - - - - -">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
...
<script>
    function Choir_memberInfo(str) {
        ...
        xmlhttp.open("GET", "index.php/account/Choir_memberInfoById?q=" + str, true);
        xmlhttp.send();
    }
</script>
