                    ...
                    <div class="portlet-body form" id="print">
                        ...
                        <?php foreach ($invoice as $row){?>
                            <div class="form-body textAlignCenter">
                                ...
                                <h4><?php echo lang('acc_clastitle'); ?> : <?php echo $this->common->Choir_title($row['Choir_id']); ?></h4>
                                <p>
                                    <strong> <?php echo lang('acc_stuname'); ?> : <?php echo $this->common->Choir_member_title($row['Choir_member_id']); ?></strong><br>
                                    <?php echo lang('acc_sid'); ?> : <?php echo $row['Choir_member_id']; ?><br>
