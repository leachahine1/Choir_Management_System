                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" class="form-control" placeholder="Enter Payment Amount" name="paid_amount" data-validation="required" data-validation-error-msg="Pleas enter your payment amount.">
                                </div>
                            </div>
                            <div class="form-group">
