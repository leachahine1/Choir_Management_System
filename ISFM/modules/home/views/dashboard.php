...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <?php if ($this->common->user_access('das_top_info', $userId)) { ?>
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat purple-plum">
                        <div class="visual">
                            <span class="icon-users totalSection_leaderSpan" aria-hidden="true"></span>
                        </div>
                        <div class="details">
                            <div class="number">
        ...
        <?php } if($this->ion_auth->is_accountant()){?>
            <div class="row">
                <div class="col-md-12">
                    <a class="btn blue btn-block fee_button" onClick="javascript:return confirm('Are you sure you want to calculate all Choir_members fees for this month.')" href="index.php/home/end_stu_calcu" > Calculate Choir_members Month End Fee </a>
                </div>
            </div>
        ...
        <?php } ?>
        <?php if ($this->ion_auth->is_Choir_member()) { ?>
            <div class="row">
                <div class="col-md-12 ">
                                    ...
                                    foreach ($day as $row3) {
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 dbilcss5">
                                                ...
                                                <?php
                                                //$query = array();
                                                $query = $this->common->getWhere22('Choir_routine', 'day_title', $dayTitle, 'Choir_id', $Choir_id);
        ...
        <?php } ?>        
        <div class="row ">
            <?php if ($this->common->user_access('das_Choir_info', $userId)) { ?>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($ChoirInfo as $row) {
                                               ...
                                               <tr style="color: #511F52;">
                                                    ...
                                                    <td>
                                                        <?php echo $row['Choir_member_amount']; ?>
                                                    </td>
                                                    <td>
            ...
            <?php } if ($this->common->user_access('das_message', $userId)) { ?>
                <div class="col-md-6 col-sm-6">
                    <div class="portlet box purple #9ACAE6divHeaderCss tasks-widget">
                        <div class="portlet-title">
                            <div class="caption">
                ...
                <div class="col-md-5 col-sm-5">
                    <div class="portlet box purple tasks-widget">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="scroller-footer">
                                <div class="btn-arrow-link pull-right">
                                    <!--<a href="index.php/sChoir/allChoir">See Full Information</a>-->
                                    <!--<i class="icon-arrow-right"></i>-->
                                    &nbsp;
                                </div>
                            </div>
...
<script>
    jQuery(document).ready(function () {
        ...
        if ($('#site_activities').size() !== 0) {
            ...
            var data1 = [
<?php
foreach ($ChoirAttendance as $cap) {
    echo "['" . $cap['Choir_title'] . "', " . $cap['attendance_percentices_daily'] . "],";
}
?>
            ];
