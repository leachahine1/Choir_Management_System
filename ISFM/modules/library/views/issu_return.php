                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input  class="form-control" type="text" onkeyup="ajax_issue_resource(this.value)" name="resource_id" placeholder="<?php echo lang('lib_bidn'); ?>" data-validation="required" data-validation-error-msg="<?php echo lang('lib_sbrm'); ?>">
                                </div>
                            </div>
                        ...
                        <div class="form-actions fluid">
                            <div class="col-md-offset-3 col-md-7">
                                <button type="submit" name="submit" class="btn green" value="Submit"><?php echo lang('lib_issuresource'); ?></button>
            ...
            <div class="col-md-6 ">
                ...
                <div class="portlet box purple ">
                    ...
                    <div class="portlet-body form">
                        <?php
                        $form_attributs = array('class' => 'form-horizontal', 'role' => 'form');
                        echo form_open('library/return_resource', $form_attributs);
                        ?>
                        <div class="form-body">
                            <?php
                            if (!empty($message_2)) {
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"><?php echo lang('lib_sb'); ?><span class="requiredStar"> * </span></label>
                                <div class="col-md-6">
                                    <input  class="form-control" type="text" onkeyup="ajax_return_resource(this.value)" name="resource_id" placeholder="<?php echo lang('lib_bidn'); ?>">
                                </div>
                            </div>
...
//here is auto reload after 1 second for time and date in the top
        ...
        if (jQuery().datepicker) {
            ...
            //$('body').removeChoir("modal-open"); // fix bug when inline picker is used in modal
        }
    });

    function ajax_issue_resource(str) {
        var xmlhttp;
        if (str.length == 0) {
        ...
        xmlhttp.open("GET", "index.php/library/ajax_issue_resource?bon=" + str, true);
        xmlhttp.send();
    }
    function ajax_return_resource(str) {
        var xmlhttp;
        if (str.length == 0) {
        ...
        xmlhttp.open("GET", "index.php/library/ajax_return_resource?rbid=" + str, true);
        xmlhttp.send();
    }
