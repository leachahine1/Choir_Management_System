            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open("library/editResource?id=$id", $form_attributs);
                        ?>
                            <?php foreach ($Resource as $row) { ?>    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input  class="form-control" type="text" name="resourceTitle" value="<?php echo $row['resources_title']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label"><?php echo lang('lib_be'); ?> <span class="requiredStar"> </span></label>
                                        <div class="col-md-6">
                                            <input  class="form-control" type="text" name="resourceEdition" placeholder="Resources Editions"  value="<?php echo $row['edition']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label"><?php echo lang('lib_ba'); ?> <span class="requiredStar"> * </span></label>
                                        <div class="col-md-6">
                                            <input  class="form-control" type="text" name="resourceAuthor" placeholder="Resource's Author" value="<?php echo $row['authore']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label"><?php echo lang('lib_cate'); ?> <span class="requiredStar"> * </span></label>
                                        <div class="col-md-6">
                                            <select class="form-control" name="resourcesCategory">
