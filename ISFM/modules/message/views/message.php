                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select id="reseverGroup" onchange="selectReceiver(this.value)" class="form-control" name="receiverGroup" required>
                                        ...
                                        <option value="Choir_member"><?php echo lang('mes_stu'); ?></option>
                                        <option value="Section_leader"><?php echo lang('mes_tea'); ?></option>
                                        <option value="Section_trainers"><?php echo lang('mes_par'); ?></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <select id="ajaxResult" onchange="ChoirStuAndPar(this.value)" name="receiver" class="form-control select2me" data-placeholder="<?php echo lang('select'); ?>" required>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function ChoirStuAndPar(str) {
        ...
        xmlhttp.open("GET", "index.php/message/ajaxChoirStuAndPar?p=" + str + "&g=" + val, true);
        xmlhttp.send();
    }
