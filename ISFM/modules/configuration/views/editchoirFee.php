    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <?php echo lang('con_edit_Choir_fe'); ?> <small></small>
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    <li>
                        <i class="fa fa-home"></i>
                        <?php echo lang('con_edit_Choir_fe'); ?>
                    </li>
                    <li>
            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open_multipart('configuration/editChoirFee', $form_attributs);
                        foreach ($fees as $row) {
                            ?>
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-4 control-label"><?php echo lang('con_Choir'); ?> <span class="requiredStar"> * </span></label>
                                    <div class="col-md-3">
                                        <select class="form-control" name="Choir_title">
                                            <option selected><?php echo $row['Choir_title']; ?></option>
                                            <?php foreach ($ChoirTile as $row1) { ?>
                                                <option value="<?php echo $row1['Choir_title']; ?>"><?php echo $row1['Choir_title']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label"><?php echo lang('con_rece_resource'); ?><span class="requiredStar"> * </span></label>
                                    <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label"><?php echo lang('con_rehearsal_fee'); ?><span class="requiredStar"> * </span></label>
                                    <div class="col-md-3">
                                        <input type="text" class="form-control" placeholder="For one Rehearsal (1st, 2nd, 3rd rehearsal fee) " value="<?php echo $row['rehearsal_fee']; ?>" name="rehearsal_fee" data-validation="required" data-validation-error-msg="<?php echo lang('con_pl_gta'); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label"><?php echo lang('con_twf'); ?> <span class="requiredStar"> * </span></label>
                                    <div class="col-md-3">
                                        <input type="text" class="form-control" placeholder="- - - - - - " value="<?php echo $row['section_leader_welfare_fund']; ?>" name="section_leader_welfare_fund" data-validation="required" data-validation-error-msg="<?php echo lang('con_pl_gta'); ?>">
                                    </div>
                                </div>
                            </div>
