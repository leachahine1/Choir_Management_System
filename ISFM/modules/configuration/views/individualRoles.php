                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select id="reseverGroup" onchange="selectReceiver(this.value)" class="form-control" name="receiverGroup" required>
                                        ...
                                        <option value="3"><?php echo lang('gr_Choir_member'); ?></option>
                                        <option value="4"><?php echo lang('gr_section_leader'); ?></option>
                                        <option value="5"> <?php echo lang('gr_section_trainers'); ?></option>
