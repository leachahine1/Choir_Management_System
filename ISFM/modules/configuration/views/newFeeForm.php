    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <?php echo lang('con_new_Choir_fee'); ?> <small></small>
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <?php echo lang('con_new_Choir_fee'); ?>
                    </li>
            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box purple ">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open_multipart('configuration/configChoirFee', $form_attributs);
                        ?>
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <select class="form-control" name="Choir_title">
                                        <option <?php
                                        if (!empty($row['Choir_title'])) {
                                            echo 'selected';
                                        }
                                        ?>><?php
                                                if (!empty($row['Choir_title'])) {
                                                    echo $row['Choir_title'];
                                                } else {
                                                    echo 'Select one';
                                                }
                                                ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" placeholder="For one Rehearsal (1st, 2nd, 3rd rehearsal fee) " value="" name="rehearsal_fee" data-validation="required" data-validation-error-msg="<?php echo lang('con_pl_gta'); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label"><?php echo lang('con_twf'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-3">
                                    <input type="text" class="form-control" placeholder="- - - - - - " value="" name="section_leader_welfare_fund" data-validation="required" data-validation-error-msg="<?php echo lang('con_pl_gta'); ?>">
                                </div>
                            </div>
                        </div>
