...
class Notice extends CI_Controller {
     ...
     * 		http://rehearsalple.com/index.php/Notice
     * 	- or -  
     * 		http://rehearsalple.com/index.php/notice/<method_name>
     */
    ...
    public function allNotice() {
        ...
        if ($this->ion_auth->is_admin()) {
            ...
            $data['notice'] = $this->noticemodel->getSection_leaderNotice();
            $this->load->view('temp/header');
            $this->load->view('notisBoard', $data);
            $this->load->view('temp/footer');
        } elseif ($this->ion_auth->is_Choir_member() || $this->ion_auth->is_section_trainers()) {
            //Whice notice is created for Choir_member these notice can see both Choir_members and section_trainers.
            $data['notice'] = $this->noticemodel->getChoir_memberNotice();
            $this->load->view('temp/header');
            $this->load->view('notisBoard', $data);
            $this->load->view('temp/footer');
        } else {
