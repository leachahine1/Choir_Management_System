                    ...
                    <div class="portlet-body nimHeight">
                        <div class="table-scrollable">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    <?php foreach ($concert as $row) { ?>
                                        <tr>
                                            <td>
                                                <?php echo $row['concert_name']; ?>
                                            </td>
                                            <td>
                                                <?php echo $row['concert_for']; ?>
                                            </td>
                                            <td>
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                            ...
                            <tbody>
                                <?php foreach ($concertRoom as $row1) { ?>
                                    <tr class="odd gradeX">
                                        <td>
                                            <?php echo $row1['concert_name']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row1['room']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row1['seat_amount']; ?>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                ...
                <div class="portlet box green">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            <tbody>
                                <?php foreach ($concert_seat as $row2) { ?>
                                    <tr>
                                        <td>
                                            <?php echo $row2['concert_name']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row2['room_number']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row2['seat_number']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row2['Choir_member_id']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row2['Choir_member_name']; ?>
                                        </td>
                                        <td>
                                            <?php echo $row2['Choir']; ?>
                                        </td>
                                        ...
                                        <td>
                                            <a class="btn btn-xs green" href="index.php/concert/showDeatails?id=<?php echo $row2['id']; ?>"> <i class="fa fa-paper-plane-o"></i> <?php echo lang('dor_vd'); ?> </a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
