            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box purple ">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open_multipart('users/addSection_leader', $form_attributs);
                        ?>
                        <div class="form-body">
                            <?php
                            if (!empty($success)) {
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="position" data-validation="required" data-validation-error-msg="You have to select anyone.">
                                        ...
                                        <option value="Senior Section_leader"> <?php echo lang('tea_st'); ?> </option>
                                        <option value="Section_leader"> <?php echo lang('tea_section_leader'); ?> </option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
