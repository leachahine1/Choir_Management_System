                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($this->ion_auth->is_admin()) { ?>
                                                ...
                                                <a class="btn btn-xs red" href="index.php/users/section_leaderDelete?id=<?php echo $row['id']; ?>&uid=<?php echo $row['user_id']; ?>""  onClick="javascript:return confirm('Are you sure you want to delete this section_leader?')"> <i class="fa fa-trash-o"></i> Delete </a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                    <?php
