 ...
 */
$config['site_title'] = "Rehearsalple.com";       // Site Title, rehearsalple.com
$config['admin_email'] = "admin@rehearsalple.com"; // Admin Email, admin@rehearsalple.com
$config['default_group'] = 'members';           // Default group, use name
$config['admin_group'] = 'admin';             // Default administrators group, use name
$config['Choir_member_group'] = 'Choir_member';
$config['section_leader_group'] = 'section_leader';
$config['section_trainers_group'] = 'section_trainers';
$config['accountant_group'] = 'accountant';
