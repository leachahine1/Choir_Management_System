...
max_score, alignment1_chars, alignment2_chars, aligned_tuples = smith_waterman(linked_notes1, adjusted_note_durations_list2)


print(alignment1_chars, alignment2_chars)
print("_______________")
print("Alignments:")
for i in range(len(alignment1_chars)):
    if alignment1_chars[i] is not None and alignment2_chars[i] is not None:
        print(f"Tuple from seq1: {alignment1_chars[i]}, Tuple from seq2: {alignment2_chars[i]}")
    elif alignment1_chars[i] is not None:
        print(f"Tuple from seq1: {alignment1_chars[i]}, No matching tuple from seq2")
    elif alignment2_chars[i] is not None:
        print(f"No matching tuple from seq1, Tuple from seq2: {alignment2_chars[i]}")
